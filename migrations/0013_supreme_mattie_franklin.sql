...
ALTER TABLE "registration_fields" ADD COLUMN "group_label_id" uuid;--> statement-breakpoint
ALTER TABLE "registration_data" ADD COLUMN "user_id" uuid;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "registration_fields" ADD CONSTRAINT "registration_fields_group_label_id_group_category_id_fk" FOREIGN KEY ("group_label_id") REFERENCES "group_category"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
